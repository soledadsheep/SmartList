; (function (root) {
    ...
    root.SmartList.theme('tailwind', function (instance, cfgs = {}) {
        return {
            classMap: {
                ...
                tag: 'flex items-center bg-blue-500 text-white rounded gap-1 px-2 py-0.5 hover:opacity-80',
                tagLabel: '',
                tagRemove: 'cursor-pointer opacity-70 hover:opacity-100',
